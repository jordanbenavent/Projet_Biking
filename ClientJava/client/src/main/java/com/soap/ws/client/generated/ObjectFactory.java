...
public class ObjectFactory {
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link String }{@code >}
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "departure", scope = GetRoute.class)
    public JAXBElement<String> createGetRouteDeparture(String value) {
        return new JAXBElement<String>(_GetRouteDeparture_QNAME, String.class, GetRoute.class, value);
    }
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link String }{@code >}
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "arrival", scope = GetRoute.class)
    public JAXBElement<String> createGetRouteArrival(String value) {
        return new JAXBElement<String>(_GetRouteArrival_QNAME, String.class, GetRoute.class, value);
    }
