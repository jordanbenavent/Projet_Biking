...
namespace ServeurSoapBiking
{
    ...
    public class ServiceBiking : IServiceBiking
    {
        ...
        public string getRoute(string departure, string arrival)
        {
            ...
            Task<Position> positionDepartStation = getPositionOfStationClosteToLocalisation(departAdress, "departure");
            Task<Position> positionArrivalStation = getPositionOfStationClosteToLocalisation(arrivalAdress, "arrival");
        ...
        public static async Task<Adress> getAdress(string adress)
        {
            try
            {
                HttpResponseMessage responseContract = await Program.client.GetAsync("https://api.openrouteservice.org/geocode/search?" + "api_key=5b3ce3597851110001cf6248ef8e516750bc49299e348e1eaa4301d3&text=" + adress);
        ...
        public async Task<Position> getPositionOfStationClosteToLocalisation(Task<Adress> localisation, string DorA)
        {
            try
            {
                ...
                string responseBody = proxy.getContracts();
