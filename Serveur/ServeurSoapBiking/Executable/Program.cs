...
namespace Executable
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Uri httpUrl = new Uri("http://localhost:8733/Design_Time_Addresses/ServeurSoapBiking/Routing/");

            //Create ServiceHost
            ServiceHost host = new ServiceHost(typeof(ServiceBiking), httpUrl);
            ...
            host.AddServiceEndpoint(typeof(IServiceBiking), new BasicHttpBinding(), "");
